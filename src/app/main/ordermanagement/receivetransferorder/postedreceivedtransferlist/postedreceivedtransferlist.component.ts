...
@Component({
  ...
  templateUrl: './postedreceivedtransferlist.component.html',
  styleUrls: ['./postedreceivedtransferlist.component.scss']
})
export class PostedreceivedtransferlistComponent implements OnInit {

  displayedColumns: string[] = ['document_no','shipment_no','receipt_no', 'from_location','from_location_id', 'to_location','to_location_id', 'order_status',
    'total_quantity','total_transfer_cost','total_gst_amount','total_transfer_cost_with_gst', 'total_quantity_shipped',
    'total_quantity_received','total_shortage','created_date','created_by','ship_date','shipped_by','received_on','recevied_by', 'Action'];
