...
export class TransferlistComponent implements OnInit {
  ...
  displayedColumns: string[] = ['document_no', 'from_location','from_location_id', 'to_location','to_location_id', 'order_status',
    'total_quantity','total_transfer_cost',
    'total_gst_amount','total_transfer_cost_with_gst', 'total_quantity_shipped','total_quantity_received','created_date','created_by', 'Action'];
